...
const AdminDashboard = ({ user }) => {
    ...
    const handleApproveUser = async (userId) => {
        ...
        // Don't send roleOverride unless you want to force change it
        try { await api.post(`/admin/approvals/${userId}/approve`, {}); fetchAllData(); } catch (e) { alert("Failed"); }
    };
    ...
    const handleBulkApprove = async () => {
        ...
        // Don't enforce role here either, let backend keep requested role
        try { await api.post('/admin/approvals/bulk-approve', { userIds: selectedUsers }); setSelectedUsers([]); fetchAllData(); } catch (e) { alert("Failed"); }
    };
