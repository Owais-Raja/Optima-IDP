...
import { BookOpen, Target, Award, ArrowRight, Play, Calendar, Zap } from 'lucide-react';
...
function Home() {
  ...
  if (user) {
    ...
    // Employee "My Day" / Command Center View
    return (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                ...
                {metrics?.currentFocus ? (
                  <div className="group relative bg-slate-800/50 rounded-xl p-4 border border-slate-700 hover:border-purple-500/50 transition-all flex items-center gap-4 cursor-pointer">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link to="/profile" className="p-3 rounded-lg bg-purple-500/10 border border-purple-500/20 hover:bg-purple-500/20 hover:border-purple-500/40 transition-all text-center group">
                    <div className="mx-auto mb-2 w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400 group-hover:scale-110 transition-transform">
                      <Award className="w-4 h-4" />
                    </div>
                    <span className="text-xs font-medium text-purple-200">My Skills</span>
                  </Link>
                  <Link to="/idp/create" className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 hover:bg-blue-500/20 hover:border-blue-500/40 transition-all text-center group">
                    <div className="mx-auto mb-2 w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 group-hover:scale-110 transition-transform">
                      <Target className="w-4 h-4" />
                    </div>
                    <span className="text-xs font-medium text-blue-200">New Goal</span>
                  </Link>
                </div>
              </div>
