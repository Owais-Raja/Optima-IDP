...
// -------------------------------------------------------------------------------------------------
// Displays high-level metrics (KPI cards) tailored to the user's role.
// Roles handled:
// - Admin: System health, user counts, incidents.
// - Manager: Team size, pending reviews, skill average.
// - Employee: Active plans, completed goals, current level.
// =================================================================================================
