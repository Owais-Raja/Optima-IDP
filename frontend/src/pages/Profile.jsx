...
// -------------------------------------------------------------------------------------------------
// User profile management and overview.
// Features:
// - View and update general information (Avatar, Name).
// - Skill Capability Matrix (Radar Chart).
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 sm:p-8 font-sans flex justify-center">
      <div className="max-w-7xl w-full">
        ...
        {/* ======================= Header Section ======================= */}
        {/* User Avatar, Name, Role, Level, and Logout */}
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 min-h-[500px]">
              ...
              {activeTab === 'security' && (
                <div className="space-y-8 max-w-xl">
                  ...
                  {/* Security Tab Content ends here */}
                </div>
              )}
